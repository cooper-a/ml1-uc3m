...
class Game(object):
    ...
    def run(self):
        ...
        if not existsFile:
            file.write("posPacmanX,posPacmanY,directionPacman,directionGhost1,directionGhost2,directionGhost3,"
                       "directionGhost4, "
                       "distanceGhosts1,directionGhost2,directionGhost3,directionGhost4,walls_flattened,"
                       "wallDimensionsX,wallDimensionsY,posGhost1X,posGhost1Y,posGhost2X,posGhost2Y,posGhost3X,"
